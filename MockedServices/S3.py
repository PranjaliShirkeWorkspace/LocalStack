...
class S3Storage:
    ...
    def __init__(self) -> None:
        ...
        self._s3_resource = boto3.resource('s3', region_name='us-west-2', endpoint_url=self._endpoint_url)
        self._s3_client = boto3.client('s3', region_name='us-west-2', endpoint_url=self._endpoint_url)
